...
public class ContentsController {
    ...
    public ApiResponse<Object> bookmark(@AuthenticationPrincipal UserDetails userDetails, @RequestBody ContentsRequest.BookmarkRequest request) {
    ...
    public ApiResponse<ContentsResponse.BookmarkResponse> getBookmark(@AuthenticationPrincipal UserDetails userDetails,
                                                                      @RequestParam(required = false) Long categoryId) {

        Long uid = Long.valueOf(userDetails.getUsername());   // 유저 ID
        ContentsResponse.BookmarkResponse response = contentsQueryService.getBookmark(uid, categoryId);
